export const ACTIONS = {
  ...
  GET_BLOG_POST_PREVIEW: "GET_BLOG_POST_PREVIEW",
  // mvp-plan F2 — enrollment group-type preview (template editor right panel)
  GET_ENROLLMENT_TYPES_LIST: "GET_ENROLLMENT_TYPES_LIST",
  GET_ENROLLMENT_PREVIEW: "GET_ENROLLMENT_PREVIEW",
  CREATE_COLLECTION_ITEM: "CREATE_COLLECTION_ITEM",
  GET_PAGE_TYPES: "GET_PAGE_TYPES",
  // CMS collection management (blog-templates-cms F2.5)
  CREATE_COLLECTION: "CREATE_COLLECTION",
  UPDATE_COLLECTION: "UPDATE_COLLECTION",
  DELETE_COLLECTION: "DELETE_COLLECTION",
  CREATE_COLLECTION_TEMPLATE: "CREATE_COLLECTION_TEMPLATE",
  UPDATE_COLLECTION_TEMPLATE: "UPDATE_COLLECTION_TEMPLATE",
  DELETE_COLLECTION_TEMPLATE: "DELETE_COLLECTION_TEMPLATE",
  // Template layout editing (blog-templates-cms F4)
