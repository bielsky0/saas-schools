...
/**
 * Test-only webhook simulator for subscription invoice.payment_failed events (F12d).
 * Disabled in production.
 *
 * Simulates an invoice.payment_failed event on the Connect webhook to mark a
 * subscription as past_due and send a notification to the client.
 */
type Body = {
