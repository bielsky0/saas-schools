...
## Corpus Check
- 775 files · ~579,725 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3548 nodes · 9823 edges · 272 communities (186 shown, 86 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 143 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `cb800e5a`
...
1. `TenantDb` - 200 edges
2. `withTenant()` - 145 edges
3. `recordAudit()` - 100 edges
4. `requireOrgPermission()` - 88 edges
5. `Button()` - 69 edges
6. `cn()` - 65 edges
...
## Communities (272 total, 86 thin omitted)

### Community 0 - "Email Adapter & RFC Standards"
Cohesion: 0.12
Nodes (24): AcademyHome(), OrgFilesPage(), MembersPage(), OrgSettingsPage(), TrainersPage(), ActionState, initial, RevokeInviteButton() (+16 more)
...
Cohesion: 0.13
Nodes (32): finishSignIn(), ForgotPasswordState, FormState, requestPasswordResetAction(), resetPasswordAction(), ResetPasswordState, safeCallbackUrl(), signInAction() (+24 more)

### Community 5 - "Group/Location Admin Pages"
Cohesion: 0.14
Nodes (29): GroupTypeDetailPage(), TEACHING_ROLES, NotificationSettingsPage(), Badge(), Card(), CardContent(), CardHeader(), CardTitle() (+21 more)

### Community 6 - "Org Actions & Audit Recording"
Cohesion: 0.05
Nodes (93): POST(), POST(), GroupTypesPage(), LocationsPage(), PurchasesPage(), SchedulePage(), OrgsLayout(), changed() (+85 more)

### Community 7 - "E2E Admin/Invite Helpers"
Cohesion: 0.11
Nodes (22): ADMIN_ROUTES, loginAs(), seedConnectOrg(), seedBillingOrg(), seedBillingOrg(), loginViaUi(), registerViaApi(), seedOrg() (+14 more)

### Community 8 - "Cron Job Handlers"
Cohesion: 0.13
Nodes (18): EnqueueNotificationInput, EnqueueNotificationOptions, BillingNotifyOwner, DrainResult, EnqueueOptions, JobContext, JobHandler, JobName (+10 more)

### Community 9 - "Root Layout & Metadata"
Cohesion: 0.03
Nodes (70): AuditActor, startConnectGroupChangeCheckout(), ConfirmCashPurchaseInput, BookingNotFoundError, ForeignSessionError, markAttendance(), MarkAttendanceInput, MarkAttendanceResult (+62 more)

### Community 10 - "Audit Trail Types"
Cohesion: 0.21
Nodes (12): stopImpersonatingAction(), AUDIT_ACTIONS, AuditTargetType, StopImpersonatingButton(), AuditListQuery, auditListQuerySchema, OrgListQuery, orgListQuerySchema (+4 more)
...
Cohesion: 0.10
Nodes (31): POST(), GET(), markAllReadAction(), markReadAction(), updateNotificationPreferencesAction(), initial, NotificationPreferencesForm(), ResolvedNotificationOwner (+23 more)
...
Cohesion: 0.07
Nodes (45): Body, ConnectPanelProps, BillingAdapter, BillingEvent, BillingEventBase, BillingEventType, BillingOperationErrorCode, BillingPaymentData (+37 more)

### Community 16 - "UI Primitive Components"
Cohesion: 0.08
Nodes (39): Alert(), AlertDescription(), AlertProps, AlertTitle(), alertVariants, BadgeProps, badgeVariants, Button() (+31 more)
...
Cohesion: 0.05
Nodes (69): POST(), Body, GET(), POST(), Body, POST(), POST(), Body (+61 more)

### Community 19 - "Credit Grant Admin Tools"
Cohesion: 0.09
Nodes (26): MyBookingsPage(), clientActor(), addExtraSessionAction(), cancelMyBookingAction(), ClientBookingState, AthleteNotOwnedError, dopisanieBooking(), DopisanieBookingResult (+18 more)
...
Cohesion: 0.18
Nodes (7): AdminLayout(), NAV, LocaleSwitcher(), ThemeProvider(), ThemeToggle(), AdminNav(), TABS
...
Cohesion: 0.15
Nodes (21): BlogIndexPage(), generateStaticParams(), generateStaticParams(), robots(), languageAlternates(), sitemap(), PostCard(), byDateDesc() (+13 more)

### Community 24 - "MCP Agent Tooling"
Cohesion: 0.18
Nodes (17): POST(), ToolName, baseHandler, handler, actorStore, getMcpActor(), McpActor, runWithMcpActor() (+9 more)

### Community 25 - "Booking Creation Logic"
Cohesion: 0.14
Nodes (24): Body, reasonFor(), startConnectCheckout(), createBookingAction(), messageFor(), Bookable(), createBooking(), CreateBookingInput (+16 more)

### Community 26 - "Marketing Pages (Blog/Docs/Home)"
Cohesion: 0.10
Nodes (22): Body, POST(), AuditEntry, FieldChange, SYSTEM_ACTOR, Writer, getUserEmailById(), autoFillCredits() (+14 more)
...
Cohesion: 0.16
Nodes (13): SessionRosterPage(), AttendanceControls(), initial, CancelBookingButton(), ConfirmCashButton(), initial, listRosterForSession(), EnterGradeForm() (+5 more)
...
Cohesion: 0.11
Nodes (32): Body, PaymentStatus, listGroupTypes(), listRecurrences(), athlete, account, oauthAccessToken, oauthApplication (+24 more)
...
Cohesion: 0.12
Nodes (21): GET(), Body, EXCLUDED_TABLES, ownerColumns(), OwnerRef, POST(), PROBE_TABLES, ProbeTable (+13 more)

### Community 38 - "File Ownership Records"
Cohesion: 0.14
Nodes (24): fetchOrganizationIdsContainingFile(), GET(), DELETE(), GET(), POST(), ResolvedOwner, resolveStorageOwner(), createFileRecord() (+16 more)
...
Cohesion: 0.22
Nodes (9): BlogPostPage(), generateMetadata(), PageProps, publishedPost(), authorFor(), mdxElements, blogPostingJsonLd(), CONTENT_LOCALE (+1 more)
...
Cohesion: 0.14
Nodes (14): authorized(), GET(), log, log, Member, POST(), toDnsLabel(), resolveUniqueSlug() (+6 more)

### Community 43 - "Structured Logger Core"
Cohesion: 0.13
Nodes (20): POST(), Body, POST(), kickDrain(), log, contextStore, createLogger(), emit() (+12 more)

### Community 44 - "Checkout/Portal Input Schemas"
Cohesion: 0.14
Nodes (22): POST(), GET(), countrySchema, POST(), POST(), POST(), OrgBillingPage(), isSupportedCountry() (+14 more)
...
Cohesion: 0.15
Nodes (15): generateMetadata(), LoginPage(), safeCallbackUrl(), generateMetadata(), Image(), generateMetadata(), generateMetadata(), generateMetadata() (+7 more)

### Community 47 - "Enrollment Booking Flow"
Cohesion: 0.09
Nodes (38): AdminIndexPage(), AdminPlansPage(), AdminPlansClient(), AdminPlansClientProps, FEATURE_KEYS, FeatureRow(), formatFeatureKey(), formatLimitKey() (+30 more)
...
Cohesion: 0.07
Nodes (40): FormField(), FormMessage(), Input(), SelectContent(), SelectItem(), SelectTrigger(), UserFilters(), ConfirmCashPurchaseForm() (+32 more)
...
Cohesion: 0.15
Nodes (18): POST(), GET(), GET(), POST(), SiteLayout(), deleteSessionByTokenHash(), findLiveSessionByTokenHash(), touchSession() (+10 more)
...
Cohesion: 0.18
Nodes (13): geistMono, geistSans, generateMetadata(), RootLayout(), FEATURES, Home(), planBullets(), getAllActivePlans() (+5 more)

### Community 67 - "Billing Owner Listing Queries"
Cohesion: 0.18
Nodes (14): loginBlocked(), clientIp(), ipv6Prefix(), normalize(), byMethod(), CREDENTIAL_PATHS, LOGIN_RULE, loginRateLimitKey() (+6 more)
...
Cohesion: 0.14
Nodes (11): CreateBookingState, CalendarDay, CalendarSlot, Calendar(), cellClass(), EnrollmentFlow(), EnrollmentFlowProps, initial (+3 more)
...
Cohesion: 0.08
Nodes (32): Body, GET(), POST(), AcademyDirectory(), DashboardPage(), PersonalDashboard(), AppLayout(), NewOrganizationPage() (+24 more)

### Community 76 - "OTP Request/Verify Schemas"
Cohesion: 0.12
Nodes (26): addProgressNoteAction(), createGradeFieldAction(), enterGradeAction(), initial, ProgressNoteForm(), getGradeField(), getGradeForBookingField(), listGradeFieldsForGroupType() (+18 more)

### Community 77 - "Invitation Acceptance Flow"
Cohesion: 0.20
Nodes (9): Body, POST(), assertConnectActive(), startConnectPackageCheckout(), startConnectSubscriptionCheckout(), checkoutPackageAction(), checkoutSubscriptionAction(), clientStripeCustomer (+1 more)

### Community 78 - "client-auth/rate-limit.ts"
Cohesion: 0.12
Nodes (26): ChangelogPage(), generateMetadata(), DocsIndexPage(), PageProps, DocPage(), generateMetadata(), PageProps, publishedDoc() (+18 more)

### Community 79 - "Location Edit Forms"
Cohesion: 0.10
Nodes (37): RFC-4647, PageMetadataInput, setLocaleAction(), isLocale(), Locale, localeFromPathname(), LOCALES, negotiateLocale() (+29 more)

### Community 80 - "Host Parsing Utilities"
Cohesion: 0.13
Nodes (27): GET(), ensureBillingCustomer(), openBillingPortal(), returnUrl(), startCheckout(), BillingOwner, BillingRecipients, ENTITLING_STATUSES (+19 more)

### Community 81 - "personalAccount"
Cohesion: 0.18
Nodes (11): checkFeatureServer(), checkLimitServer(), checkLimit(), enqueueApproachingNotification(), enqueueLimitReachedNotification(), getEffectiveLimit(), getResourceUsage(), LimitKey (+3 more)
...
Cohesion: 0.27
Nodes (10): findBillingCustomer(), applyPaymentEvent(), CustomerOwner, enqueuePaymentNotification(), enqueueSubscriptionNotification(), log, ownerOf(), processBillingEvent() (+2 more)
...
Cohesion: 0.05
Nodes (37): @aws-sdk/client-s3, @aws-sdk/s3-presigned-post, @aws-sdk/s3-request-presigner, better-auth, class-variance-authority, clsx, @formatjs/intl-localematcher, @mdx-js/react (+29 more)
...
Cohesion: 0.06
Nodes (29): CreateAthleteValues, RegisterClientValues, ValidationTranslator, AddProgressNoteValues, CreateGradeFieldValues, EnterGradeValues, gradeFieldType, t (+21 more)

### Community 125 - "purge.ts"
Cohesion: 0.14
Nodes (17): seed(), GET(), retentionCutoff(), groupChangesExpireHandler(), log, refundsRecoverHandler(), resolveConnectAccount(), log (+9 more)
...
Cohesion: 0.26
Nodes (12): buildTenantOrigin(), HostContext, isValidLabel(), LOOPBACK_HOSTS, normalizeHost(), parseHost(), portOf(), apexUrl() (+4 more)
...
## Knowledge Gaps
- **747 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `semi`, `singleQuote`, `trailingComma` (+742 more)
...
- **Why does `withTenant()` connect `Org Actions & Audit Recording` to `Email Adapter & RFC Standards`, `Group/Location Admin Pages`, `Root Layout & Metadata`, `Dashboard & Billing Owner Resolution`, `withSystemBypass`, `Client OTP Rules`, `Credit Grant Admin Tools`, `MCP Agent Tooling`, `Booking Creation Logic`, `Marketing Pages (Blog/Docs/Home)`, `Booking & Client Queries`, `Auth/Billing Core Tables`, `Booking Domain Tables`, `Tenant Isolation Probe Tooling`, `Blog/Changelog Sitemap Metadata`, `Group Type Creation Form`, `Recurrence Form Selects`, `Client Session Persistence`, `E2E Booking/Location Helpers`, `Billing Notification Application`, `Org Consent & Impersonation UI`, `E2E Environment Config`, `OTP Request/Verify Schemas`, `Invitation Acceptance Flow`, `Host Parsing Utilities`?**
  _High betweenness centrality (0.036) - this node is a cross-community bridge._
- **Why does `TenantDb` connect `Client OTP Rules` to `Email Adapter & RFC Standards`, `Group/Location Admin Pages`, `Org Actions & Audit Recording`, `Root Layout & Metadata`, `Notification Preferences Actions`, `Dashboard & Billing Owner Resolution`, `withSystemBypass`, `Credit Grant Admin Tools`, `Booking Creation Logic`, `Marketing Pages (Blog/Docs/Home)`, `Org Dashboard Pages`, `Booking & Client Queries`, `Auth/Billing Core Tables`, `Booking Domain Tables`, `File Ownership Records`, `Blog/Changelog Sitemap Metadata`, `Checkout/Portal Input Schemas`, `Client Session Persistence`, `E2E Booking/Location Helpers`, `Org Consent & Impersonation UI`, `E2E Environment Config`, `OTP Request/Verify Schemas`, `Host Parsing Utilities`, `personalAccount`, `[...all]/route.ts`, `storage/schema.ts`, `File Upload Presign Schema`, `purge.ts`?**
  _High betweenness centrality (0.027) - this node is a cross-community bridge._
- **Why does `env` connect `Group Type Creation Form` to `Email Unsubscribe & Categories`, `Admin Auth & OAuth RFCs`, `Login & Password Reset Forms`, `Cron Job Handlers`, `user-locale.ts`, `Billing Event Types`, `Client OTP Rules`, `Rate Limit Adapter Core`, `MCP Agent Tooling`, `Booking Creation Logic`, `Marketing Pages (Blog/Docs/Home)`, `Billing Panel Pages`, `Public Page Routing`, `Auth/Billing Core Tables`, `Tenant Isolation Probe Tooling`, `Structured Logger Core`, `Background Job Admin API`, `Storage Adapter Types`, `Client Session Persistence`, `E2E Booking/Location Helpers`, `Billing Notification Application`, `Billing Owner Listing Queries`, `E2E Environment Config`, `Invitation Acceptance Flow`, `Location Edit Forms`, `Host Parsing Utilities`, `Docs Search Index`?**
