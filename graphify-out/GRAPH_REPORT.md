# Graph Report - saas-school  (2026-07-26)

## Corpus Check
- 844 files · ~650,023 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3805 nodes · 10864 edges · 288 communities (200 shown, 88 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 158 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a39176c3`
...
1. `TenantDb` - 248 edges
2. `withTenant()` - 190 edges
3. `requireOrgPermission()` - 122 edges
4. `recordAudit()` - 120 edges
5. `Button()` - 83 edges
6. `resolveActor()` - 68 edges
7. `uniqueEmail()` - 65 edges
8. `cn()` - 65 edges
9. `withSystemBypass()` - 58 edges
10. `organization` - 57 edges
...
- `OverrideRow` --indirect_call--> `deactivatePriceOverrideAction()`  [INFERRED]
  src/app/[locale]/(app)/dashboard/clients/[clientId]/client-override-manager.tsx → src/features/pricing/actions.ts
- `GrantForm()` --indirect_call--> `grantPriceOverrideAction()`  [INFERRED]
  src/app/[locale]/(app)/dashboard/clients/[clientId]/client-override-manager.tsx → src/features/pricing/actions.ts
- `PendingInvoiceCard()` --indirect_call--> `markInvoiceIssuedAction()`  [INFERRED]
  src/features/billing/components/invoice-pending-list.tsx → src/features/billing/invoice-actions.ts
...
Cohesion: 0.05
Nodes (75): RFC-2369, POST(), countrySchema, POST(), POST(), POST(), POST(), RFC-8058 (+67 more)

### Community 2 - "Admin Auth & OAuth RFCs"
Cohesion: 0.21
Nodes (14): RFC-7591, adminErrorResult(), betterAuthAdminAdapter, errorCode(), NOTE: the engine throws a 500 here when the admin's ORIGINAL session has, staffSessionHandoffVerifyQuerySchema, AuthErrorCode, AuthResult (+6 more)
...
Cohesion: 0.12
Nodes (19): MembersPage(), Card(), CardContent(), CardDescription(), CardFooter(), CardHeader(), CardTitle(), ConfirmCashPurchaseForm() (+11 more)

### Community 6 - "Org Actions & Audit Recording"
Cohesion: 0.27
Nodes (7): createLocationAction(), deactivateLocationAction(), deactivateLocation(), DeactivateLocationResult, LocationNotFoundError, createLocationSchema(), listFutureSessionsForLocation()

### Community 7 - "E2E Admin/Invite Helpers"
Cohesion: 0.14
Nodes (11): ADMIN_ROUTES, loginViaUi(), registerViaApi(), seedSuperAdmin(), tenantOrigin(), test, uniqueBucket(), failLogin() (+3 more)

### Community 8 - "Cron Job Handlers"
Cohesion: 0.06
Nodes (76): RFC-5322, POST(), GET(), EmailAdapter, Recipient, RenderedEmail, SendOptions, TemplateData (+68 more)

### Community 9 - "Root Layout & Metadata"
Cohesion: 0.11
Nodes (24): EarningsPage(), RatesPage(), listGroupTypes(), EarningsReportClient(), RatesPageClient(), listTrainers(), calculateAmount(), EarningsLine (+16 more)
...
Cohesion: 0.08
Nodes (36): loginAs(), Fixture, seedPendingBooking(), Fixture, seedConnectOrg(), signedConnectRequest(), connectAccountDeauthorizedEvent(), connectAccountUpdatedEvent() (+28 more)

### Community 12 - "Notification Preferences Actions"
Cohesion: 0.30
Nodes (10): POST(), updateNotificationPreferencesAction(), initial, NotificationPreferencesForm(), setPreference(), isNotificationType(), isSuppressibleType(), NOTIFICATION_META (+2 more)

### Community 13 - "Dashboard & Billing Owner Resolution"
Cohesion: 0.13
Nodes (32): GroupTypeDetailPage(), TEACHING_ROLES, GroupTypesPage(), LocationsPage(), Badge(), Pagination(), PaginationLink(), Table() (+24 more)
...
Cohesion: 0.06
Nodes (43): DeleteOverrideButton(), initial, Alert(), AlertDescription(), AlertProps, AlertTitle(), alertVariants, BadgeProps (+35 more)
...
Cohesion: 0.07
Nodes (26): checkFeatureServer(), checkLimitServer(), checkLimit(), enqueueApproachingNotification(), enqueueLimitReachedNotification(), getEffectiveLimit(), getResourceUsage(), LimitKey (+18 more)

### Community 19 - "Credit Grant Admin Tools"
Cohesion: 0.10
Nodes (13): clientActor(), BookingAlreadyCancelledError, BookingNotFoundError, CancellationTooLateError, addExtraSessionAction(), cancelMyBookingAction(), ClientBookingState, AthleteNotOwnedError (+5 more)

### Community 20 - "Rate Limit Adapter Core"
Cohesion: 0.09
Nodes (37): POST(), POST(), OTP_ISSUE_EMAIL_RULE, OTP_ISSUE_IP_RULE, OTP_VERIFY_EMAIL_RULE, OTP_VERIFY_IP_RULE, consumeOtp(), insertClientSession() (+29 more)

### Community 21 - "Billing Notification Handlers"
Cohesion: 0.09
Nodes (18): Body, PaymentStatus, listRecurrences(), DeactivateGroupTypeInput, GroupTypeDeactivationBlock, GroupTypeDeactivationBlockedError, GroupTypeNotFoundError, listFutureSessionsForRecurrence() (+10 more)

### Community 22 - "Client OTP Session Flow"
Cohesion: 0.31
Nodes (15): uniqueId(), seedLanglion(), seedOrgFull(), uniqueEmail(), uniqueNearFutureSlot(), uniqueSubdomain(), seedAcademy(), seedAcademy() (+7 more)

### Community 23 - "Group Type & Recurrence Actions"
Cohesion: 0.28
Nodes (14): generateStaticParams(), languageAlternates(), sitemap(), DocCategoryId, byDateDesc(), ChangelogGroup, DocCategory, isPublished() (+6 more)

### Community 24 - "MCP Agent Tooling"
Cohesion: 0.12
Nodes (22): GET(), markAllReadAction(), markReadAction(), ResolvedNotificationOwner, resolveNotificationOwner(), countUnread(), createNotification(), isInAppSuppressed() (+14 more)

### Community 25 - "Booking Creation Logic"
Cohesion: 0.08
Nodes (49): Body, reasonFor(), createBookingAction(), createBookingManyAction(), CreateBookingState, messageFor(), messageForLabel(), parseAthleteConsents() (+41 more)

### Community 26 - "Marketing Pages (Blog/Docs/Home)"
Cohesion: 0.06
Nodes (62): POST(), changed(), recordAudit(), resolveActor(), withImpersonation(), refundInitiateAction(), applySubscriptionEvent(), createSlotFirstBookingAction() (+54 more)

### Community 27 - "E2E Job/Email Test Helpers"
Cohesion: 0.12
Nodes (17): CapturedEmail, getNotifications(), getUserId(), getVerificationLink(), JobView, LanglionState, NotificationView, ProbeOwnerRef (+9 more)

### Community 28 - "Billing Panel Pages"
Cohesion: 0.33
Nodes (9): getSubscriptionByProviderId(), resolveBillingRecipients(), billingNotifyHandler(), LIVE_STATUSES, log, manageUrl(), notifySchema, planName() (+1 more)

### Community 29 - "Public Page Routing"
Cohesion: 0.12
Nodes (28): OrgAuditPage(), localeFromPathname(), stripLocale(), withLocale(), Indexable, isMetadataImageRoute(), isPublicPage(), PublicPagePath (+20 more)
...
Cohesion: 0.11
Nodes (34): AvailabilityRow, buildMonthGrid(), CalendarSlot, daysInMonth(), defaultMonth(), realDays(), row(), toSlot() (+26 more)

### Community 33 - "Booking & Client Queries"
Cohesion: 0.16
Nodes (20): clientLogout(), clientSessionOf(), expireCodes(), issueAndReadCode(), otpState, readOtpCode(), requestCode(), verifyCode() (+12 more)

### Community 34 - "Nav & Theme UI"
Cohesion: 0.16
Nodes (17): defaultMonthSeed(), EnrollmentPage(), todayMonth(), todayMonthWith(), listSessionAvailability(), isBookable(), OfferPaymentInput, PackageTeaser (+9 more)

### Community 35 - "Auth/Billing Core Tables"
Cohesion: 0.15
Nodes (20): ClientOverrideManager(), account, oauthAccessToken, oauthApplication, oauthConsent, session, user, verification (+12 more)

### Community 36 - "Booking Domain Tables"
Cohesion: 0.12
Nodes (24): POST(), ImportForm(), ImportPage(), PoliciesPage(), markInvoiceIssuedAction(), markInvoiceIssuedSchema, requestInvoiceSchema, OrgContext (+16 more)

### Community 37 - "Tenant Isolation Probe Tooling"
Cohesion: 0.12
Nodes (25): seed(), GET(), SYSTEM_ACTOR, retentionCutoff(), groupChangesExpireHandler(), creditsExpireHandler(), log, log (+17 more)

### Community 38 - "File Ownership Records"
Cohesion: 0.15
Nodes (22): POST(), ToolName, POST(), baseHandler, handler, actorStore, getMcpActor(), McpActor (+14 more)
...
Cohesion: 0.14
Nodes (11): confirmCashPurchaseSchema, AthleteNotFoundError, ClientNotFoundError, ConfirmCashPurchaseResult, log, ProductTemplateNotActiveError, ProductTemplateNotFoundError, PurchasePolicyViolationError (+3 more)

### Community 41 - "Blog/Changelog Sitemap Metadata"
Cohesion: 0.10
Nodes (29): POST(), OrgsLayout(), AcceptInvitationPage(), hashToken(), enqueueNotification(), acceptInvitationAction(), createOrganizationAction(), deletePermissionOverrideAction() (+21 more)

### Community 42 - "Group Type Creation Form"
Cohesion: 0.09
Nodes (24): DomainNotificationInput, DomainNotificationRecipient, EMAIL_TEMPLATE_MAP, EVENT_TYPES_WITH_EMAIL, readEventType(), readPreference(), EnqueueNotificationInput, EnqueueNotificationOptions (+16 more)

### Community 43 - "Structured Logger Core"
Cohesion: 0.05
Nodes (56): settleJobs(), GET(), Body, GET(), POST(), resolve(), Body, POST() (+48 more)

### Community 44 - "Checkout/Portal Input Schemas"
Cohesion: 0.19
Nodes (13): GET(), POST(), OrgBillingPage(), SUPPORTED_CONNECT_COUNTRIES, SupportedCountry, getOrgConnectStatus(), log, setConnectAccountId() (+5 more)
...
Cohesion: 0.06
Nodes (45): GrantForm(), GroupTypeOption, Labels, OverrideRow, initial, PermissionOverrideForm(), FormField(), FormMessage() (+37 more)
...
Cohesion: 0.11
Nodes (27): POST(), GET(), GET(), POST(), QualificationCardPage(), SiteLayout(), assertConnectActive(), requestInvoiceAction() (+19 more)
...
Cohesion: 0.11
Nodes (22): POST(), Body, GET(), POST(), POST(), ClientDetailPage(), MemberPermissionsPage(), SchedulePage() (+14 more)

### Community 64 - "Dev Dependencies"
Cohesion: 0.05
Nodes (39): @better-auth/cli, dotenv, drizzle-kit, eslint, eslint-config-next, eslint-config-prettier, devDependencies, @better-auth/cli (+31 more)
...
Cohesion: 0.15
Nodes (15): BlogPostPage(), generateMetadata(), generateStaticParams(), PageProps, publishedPost(), ChangelogPage(), generateMetadata(), authorFor() (+7 more)
...
Cohesion: 0.12
Nodes (12): AuditEntry, FieldChange, Writer, getUserEmailById(), log, refundInitiateSchema, deactivateTrainerAction(), listFutureSessionsForTrainer() (+4 more)

### Community 77 - "Invitation Acceptance Flow"
Cohesion: 0.29
Nodes (8): enqueueJob(), deactivatePriceOverrideAction(), findClient(), findGroupType(), grantPriceOverrideAction(), UnknownTargetError, deactivatePriceOverrideSchema(), grantPriceOverrideSchema()
...
Cohesion: 0.18
Nodes (17): RFC-4647, Mailbox, PageMetadataInput, isLocale(), Locale, negotiateLocale(), preferredLanguages(), Messages (+9 more)

### Community 80 - "Host Parsing Utilities"
Cohesion: 0.17
Nodes (15): QualificationCardsPage(), CardNotFoundError, completeLeaderPhaseAction(), completeParentPhaseAction(), completeLeaderPhase(), getQualificationCard(), getQualificationCardById(), listQualificationCards() (+7 more)

### Community 81 - "personalAccount"
Cohesion: 0.14
Nodes (14): AcademyHome(), OrgFilesPage(), AcademyDirectory(), DashboardPage(), OrgSettingsPage(), TrainersPage(), DeleteOrgButton(), initial (+6 more)
...
Cohesion: 0.09
Nodes (24): initial, PendingInvoiceCard(), RequestInvoiceButton(), GroupTypeDefaults, initial, billingType, CreateGroupTypeValues, CreateRecurrenceValues (+16 more)
...
Cohesion: 0.21
Nodes (10): ALL_PERMISSION_KEYS, computeEffectivePermissions(), isPermissionKey(), OVERRIDABLE_PERMISSIONS, OverrideRow, Permission, ROLE_PERMISSIONS, ROLES (+2 more)
...
Cohesion: 0.05
Nodes (37): @aws-sdk/client-s3, @aws-sdk/s3-presigned-post, @aws-sdk/s3-request-presigner, class-variance-authority, clsx, @formatjs/intl-localematcher, @mdx-js/react, negotiator (+29 more)
...
Cohesion: 0.33
Nodes (4): billingCustomer, notificationEventType, notification, personalAccount

### Community 106 - "File Upload Presign Schema"
Cohesion: 0.11
Nodes (28): processSubscriptionFailed(), adminRejectChangeRequest(), transferCredit(), addProgressNoteAction(), createGradeFieldAction(), enterGradeAction(), getGradeField(), getGradeForBookingField() (+20 more)
...
Cohesion: 0.15
Nodes (19): DocsIndexPage(), generateMetadata(), PageProps, DocPage(), generateMetadata(), PageProps, publishedDoc(), DocsSearchForm() (+11 more)
...
Cohesion: 0.11
Nodes (19): NAV, FEATURES, Home(), planBullets(), LocaleSwitcher(), ThemeToggle(), DropdownMenuContent(), DropdownMenuItem() (+11 more)

### Community 125 - "purge.ts"
Cohesion: 0.21
Nodes (15): BlogIndexPage(), generateMetadata(), Image(), Image(), robots(), OG_SIZE, ogImage(), breadcrumbJsonLd() (+7 more)

### Community 126 - "CSP Builder"
Cohesion: 0.05
Nodes (52): AuditActor, ConfirmCashPurchaseInput, cancelBooking(), CancelBookingInput, CancelBookingResult, CancellationBlockedByChangeRequestError, formatSessionDate(), loadNotificationData() (+44 more)
...
Cohesion: 0.09
Nodes (17): getLanglionState(), loginToAcademy(), registerAndVerify(), wallClockIn(), weekdayIn(), loginAndLand(), loginAndLand(), seedAcademy() (+9 more)
...
Cohesion: 0.14
Nodes (15): authorized(), GET(), log, Body, POST(), Body, POST(), Body (+7 more)

### Community 152 - "boilerplate-rls.spec.ts"
Cohesion: 0.29
Nodes (9): findBillingCustomer(), applyPaymentEvent(), CustomerOwner, enqueuePaymentNotification(), enqueueSubscriptionNotification(), log, ownerOf(), processBillingEvent() (+1 more)

### Community 155 - "change-group-cancel.ts"
Cohesion: 0.15
Nodes (14): PersonalDashboard(), AppLayout(), NewOrganizationPage(), NotificationSettingsPage(), ConsentForm(), OAuthConsentPage(), OAuthLoginBridge(), listPreferences() (+6 more)

### Community 156 - "reserved-slugs.ts"
Cohesion: 0.15
Nodes (24): fetchOrganizationIdsContainingFile(), GET(), DELETE(), GET(), POST(), resolveStorageOwner(), createFileRecord(), getFileForOwner() (+16 more)

### Community 158 - "Rozpoznanie istniejącego klienta (§6.1a)"
Cohesion: 0.18
Nodes (14): stopImpersonatingAction(), AUDIT_ACTIONS, AuditAction, AuditTargetType, ImpersonationBanner(), StopImpersonatingButton(), AuditListQuery, auditListQuerySchema (+6 more)

### Community 159 - "refund-actions.ts"
Cohesion: 0.07
Nodes (42): CreditsPage(), InvoicesPage(), PurchasesPage(), SessionRosterPage(), MyBookingsPage(), InvoicePendingList(), IssuedInvoiceRow, listClientPurchases() (+34 more)

### Community 160 - "trainers/data.ts"
Cohesion: 0.18
Nodes (6): AthleteMismatchError, CreditNotFoundError, CreditNotTransferableError, SameAthleteError, TransferCreditInput, credit

### Community 162 - "site.ts"
Cohesion: 0.20
Nodes (9): geistMono, geistSans, generateMetadata(), RootLayout(), ThemeProvider(), JsonLd(), JsonLdNode, OG_LOCALE (+1 more)

### Community 166 - "bookings/schema.ts"
Cohesion: 0.09
Nodes (35): Body, GET(), POST(), Body, autoFillCredits(), AutoFillInput, AutoFillResult, log (+27 more)
...
Cohesion: 0.33
Nodes (7): consumeStaffSessionHandoff(), staffSessionHandoffPlugin(), HostContext, isValidLabel(), LOOPBACK_HOSTS, normalizeHost(), parseHost()

### Community 174 - "invoice-data.ts"
Cohesion: 0.29
...
### Community 176 - "auth"
Cohesion: 0.29
Nodes (5): RFC-8414, RFC-9728, GET, GET, auth

### Community 177 - "tenant-host.ts"
Cohesion: 0.29
Nodes (11): returnUrl(), startConnectCheckout(), startConnectGroupChangeCheckout(), startConnectPackageCheckout(), startConnectSubscriptionCheckout(), buildTenantOrigin(), portOf(), apexUrl() (+3 more)
...
### Community 184 - "clients/schema.ts"
Cohesion: 0.07
Nodes (20): CreateAthleteValues, RegisterClientValues, ValidationTranslator, AddProgressNoteValues, CreateGradeFieldValues, EnterGradeValues, gradeFieldType, t (+12 more)

### Community 187 - "next.config.ts"
Cohesion: 0.40
Nodes (4): nextConfig, withMDX, withNextIntl, STATIC_SECURITY_HEADERS

### Community 188 - "[...all]/route.ts"
Cohesion: 0.60
...
## Knowledge Gaps
- **794 isolated node(s):** `$schema`, `.opencode/plugins/graphify.js`, `semi`, `singleQuote`, `trailingComma` (+789 more)
...
- **Why does `TenantDb` connect `refund-actions.ts` to `Email Unsubscribe & Categories`, `Group/Location Admin Pages`, `Org Actions & Audit Recording`, `Root Layout & Metadata`, `Dashboard & Billing Owner Resolution`, `package-checkout-actions.ts`, `Client OTP Rules`, `Credit Grant Admin Tools`, `Rate Limit Adapter Core`, `Billing Notification Handlers`, `boilerplate-rls.spec.ts`, `Booking Creation Logic`, `Marketing Pages (Blog/Docs/Home)`, `MCP Agent Tooling`, `Billing Panel Pages`, `reserved-slugs.ts`, `Org Dashboard Pages`, `trainers/data.ts`, `Nav & Theme UI`, `Booking Domain Tables`, `Tenant Isolation Probe Tooling`, `bookings/schema.ts`, `File Ownership Records`, `Docs Page Rendering`, `Blog/Changelog Sitemap Metadata`, `Structured Logger Core`, `Checkout/Portal Input Schemas`, `invoice-data.ts`, `Client Session Persistence`, `Billing Notification Application`, `E2E Environment Config`, `OTP Request/Verify Schemas`, `Invitation Acceptance Flow`, `Host Parsing Utilities`, `[...all]/route.ts`, `File Upload Presign Schema`, `CSP Builder`?**
  _High betweenness centrality (0.041) - this node is a cross-community bridge._
- **Why does `withTenant()` connect `Billing Notification Application` to `Group/Location Admin Pages`, `Org Actions & Audit Recording`, `Root Layout & Metadata`, `Dashboard & Billing Owner Resolution`, `UI Primitive Components`, `Client OTP Rules`, `Credit Grant Admin Tools`, `Rate Limit Adapter Core`, `Billing Notification Handlers`, `Booking Creation Logic`, `Marketing Pages (Blog/Docs/Home)`, `Billing Panel Pages`, `reserved-slugs.ts`, `refund-actions.ts`, `Nav & Theme UI`, `Auth/Billing Core Tables`, `Booking Domain Tables`, `Tenant Isolation Probe Tooling`, `bookings/schema.ts`, `File Ownership Records`, `Docs Page Rendering`, `Blog/Changelog Sitemap Metadata`, `Structured Logger Core`, `Client Session Persistence`, `E2E Environment Config`, `OTP Request/Verify Schemas`, `Invitation Acceptance Flow`, `Host Parsing Utilities`, `personalAccount`, `[...all]/route.ts`, `File Upload Presign Schema`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `Locale` connect `Location Edit Forms` to `Next.js Config & Security Headers`, `Admin Auth & OAuth RFCs`, `Login & Password Reset Forms`, `Group/Location Admin Pages`, `Onboarding Step Handler`, `Cron Job Handlers`, `File Upload Presign Schema`, `Structured Logger Core`, `Public Page Routing`, `Rate Limit Adapter Core`, `Group Type & Recurrence Actions`, `change-group-cancel.ts`, `Form Validation Types`, `purge.ts`?**
